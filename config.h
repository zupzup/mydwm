...
static const char *termcmd[]  = { "shell.sh", NULL };
static const char *screenshotcmd[]  = { "screens", NULL };
static const char *cmdprintscreen[]  = { "scrot", "/home/zupzup/Pictures/screenshots/%Y-%m-%d-%s.jpg", NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_F8,      spawn,         {.v = cmdprintscreen} },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
